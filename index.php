        ...
        <section class="popular">
            <div class="container">
                ...
                <div class="row">
						...
						$query_res= mysqli_query($db,"select * from dishes order by d_id desc"); 
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    ...
                    <div class="col-xs-12 col-sm-2 pages color-gray">
                        <h5>Pages</h5>
                        <ul>
                            <li><a href="restaurants.php">Restuarants page</a> </li>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>Concept design of online food ordering and delivery,planned as per restaurant directory</p>
                            <h5>Phone: <a href="tel:+080000012222">080 000012 222</a></h5> </div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Addition informations</h5>
                            <p>Join thousands of other restaurants who benefit from having their menus on TakeOff</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
